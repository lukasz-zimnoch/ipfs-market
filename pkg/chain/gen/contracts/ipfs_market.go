...
const IpfsMarketABI = "[{\"constant\":false,\"inputs\":[{\"internalType\":\"string\",\"name\":\"hash\",\"type\":\"string\"},{\"internalType\":\"bytes\",\"name\":\"accessKey\",\"type\":\"bytes\"},{\"internalType\":\"uint256\",\"name\":\"price\",\"type\":\"uint256\"}],\"name\":\"publish\",\"outputs\":[],\"payable\":false,\"stateMutability\":\"nonpayable\",\"type\":\"function\"}]"
...
var IpfsMarketBin = ""
...
//
// Solidity: function publish(string hash, bytes accessKey, uint256 price) returns()
func (_IpfsMarket *IpfsMarketTransactor) Publish(opts *bind.TransactOpts, hash string, accessKey []byte, price *big.Int) (*types.Transaction, error) {
	return _IpfsMarket.contract.Transact(opts, "publish", hash, accessKey, price)
}

// Publish is a paid mutator transaction binding the contract method 0x449c72a9.
//
// Solidity: function publish(string hash, bytes accessKey, uint256 price) returns()
func (_IpfsMarket *IpfsMarketSession) Publish(hash string, accessKey []byte, price *big.Int) (*types.Transaction, error) {
	return _IpfsMarket.Contract.Publish(&_IpfsMarket.TransactOpts, hash, accessKey, price)
}

// Publish is a paid mutator transaction binding the contract method 0x449c72a9.
//
// Solidity: function publish(string hash, bytes accessKey, uint256 price) returns()
func (_IpfsMarket *IpfsMarketTransactorSession) Publish(hash string, accessKey []byte, price *big.Int) (*types.Transaction, error) {
	return _IpfsMarket.Contract.Publish(&_IpfsMarket.TransactOpts, hash, accessKey, price)
}
